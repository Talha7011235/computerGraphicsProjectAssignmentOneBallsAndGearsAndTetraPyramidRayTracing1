...
bool Sphere::Intersect(const Vector3& origin, const Vector3& direction, float& tValueIsDepth, float near) const
{
	// Determine the Vector that is representing the distance from the origin and the sphere center.
	...
	// Check if the raycast has struck the Sphere.
	...
	// Set the First Intersection that is represented by the Float Point Variable "float firstIntersection" to the closer of the two values.
